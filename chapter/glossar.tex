...
\newglossaryentry{XDR}{ name={XDR}, description={External Data Representation (XDR) ist ein abstrakter technischer Kommunikationsstandard um den Datenaustausch zwischen Server und Clients Geräteunabhängig zu standardisieren. XDR ist im RFC 1014, 1832 und 4506 standardisiert}}
